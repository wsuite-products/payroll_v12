...
odoo.define('werp_web_utils.share', function (require) {
"use strict";
...
var utils = require('werp_web_utils.utils');
var copy = require('werp_web_utils.copy');
...
var CharShare = fields.CharCopyClipboard.extend(ShareMixin, {
	...
	init: function(parent, name, record) {
        ...
        this.shareOptions = _.defaults(this.nodeOptions, {
        	...
        	bodyTemplate: 'werp_web_utils.ShareMessage',
        });
    ...
    _render: function() {
        ...
        this.$el.prepend($(QWeb.render('werp_web_utils.CharShare', {
...
var TextShare = fields.TextCopyClipboard.extend(ShareMixin, {
    ...
    _render: function() {
    	this._super.apply(this, arguments);
        this.$el.addClass('mk_field_share');
        this.$el.prepend($(QWeb.render('werp_web_utils.TextShare', {
        	navigator: !!this.navigator,
        	chatter: !!this.chatter,
        })));
    }
...
var BinaryFileShare = copy.BinaryFileCopy.extend(ShareMixin, {
	...
	init: function () {
        ...
        this.shareOptions = _.defaults(this.nodeOptions, {
        	...
        	textTemplate: _t("<%= value %>"),
        	bodyTemplate: 'werp_web_utils.ShareBinaryMessage',
        });
        this.shareOptions = _.extend({}, this.shareOptions, {
        	res_model: this.recordData[this.nodeOptions.res_model] || this.model,
        	res_id: this.recordData[this.nodeOptions.res_id] || this.res_id,
	...
	_renderReadonly: function () {
        this._super.apply(this, arguments);
        this.$el.addClass('mk_field_share');
        this.$el.append($(QWeb.render('werp_web_utils.BinaryShare', {
        	navigator: !!this.navigator,
        	chatter: !!this.chatter,
        	share: !!this.shareUrl,
        })));
