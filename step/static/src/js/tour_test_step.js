odoo.define('step.tour_test_step', function (require) {
'use strict';

var tour = require('web_tour.tour');
var base = require("web_editor.base");

tour.register('test_step', {
    test: true,
    url: '/step/start/user-feedback-form-1/phantom',
    wait_for: base.ready()
},
    [
        // Page-1
        {
            content: "Clicking on Start Step",
            trigger: 'a.btn.btn-primary.btn-lg:contains("Start Step")',
        },
