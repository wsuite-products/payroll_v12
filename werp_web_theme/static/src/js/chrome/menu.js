...
odoo.define('werp_web_theme.Menu', function (require) {
"use strict";
...
var AppsBar = require("werp_web_theme.AppsBar");
...
Menu.include({
    ...
    menusTemplate: config.device.isMobile ? 
    		'werp_web_theme.MobileMenu.sections' : Menu.prototype.menusTemplate,
    start: function () {
