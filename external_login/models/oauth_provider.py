...
class AuthOauthProvider(models.Model):
    ...
    user_access_url = fields.Char('Get USer URL')

    def wadmin_oauth_token(
        ...
        data = dict(
            ...
            redirect_uri=request.env['ir.config_parameter'].sudo().get_param(
                'web.base.url') + '/auth_oauth/wadmin/signin',
        ...
        req = requests.post(oauth_provider_rec.validation_endpoint, data=data)
