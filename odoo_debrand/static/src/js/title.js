odoo.define('odoo_debrand.title', function (require) {
    "use strict";
         ...
         set_loading: function () {
            ...
            var def = this._rpc({
                ...
                .then(function (companies){
                    $('.o_main_content').append("<div style='text-align: right; padding-right: 5%; height: 8%; font-size: 160%; background: #ffffff;'><b>" + companies[0].name + "</b></div>")
                });
        },
    });
